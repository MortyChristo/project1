...
def test_add_id_already_in_use_neg(mocker):
    employee_obj = ee.Employee('100000', "ChristopSullivan", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    def mock_add(self, employee_id):
    ...
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee('100000', "JackSmith", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
...
def test_add_id_under_6_neg(mocker):
    ...
    employee_serv = es.EmployeeService()
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee(10000, "ChristopSullivan", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str(excinfo.value) == ''
...
def test_add_id_letter_neg(mocker):
    ...
    def mock_add(self, employee_obj):
        ...
        employee_serv = es.EmployeeService()
        with pytest.raises(RegistrationError) as excinfo:
            employee_serv.add_employee("10000a", "ChristopSullivan", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
...
def test_add_username_numbers_neg(mocker):
    ...
    def mock_add(self, employee_id, username, password, fName, lName, type, email):
    ...
    employee_serv = es.EmployeeService()
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee("100001", "1hristopSullivan", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str(excinfo.value) == ""
...
def test_add_username_under_6_neg(mocker):
    ...
    employee_serv = es.EmployeeService()
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee("100001", "Chris", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str(excinfo.value) == ""
...
def test_add_username_over_20_neg(mocker):
    ...
    employee_serv = es.EmployeeService()
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee("100001", "ChristopSullivanasdfn", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str(excinfo.value) == ""
...
def test_add_blank_neg(mocker):
    ...
    employee_serv = es.EmployeeService()
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee("100001", "", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str(excinfo.value) == ""
...
def test_add_lower_pass_neg(mocker):
    ...
    employee_serv = es.EmployeeService()
    with pytest.raises(RegistrationError) as excinfo:
        employee_serv.add_employee("100001", "ChristopSullivan", "PASSWORD123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str(excinfo.value) == ""
...
def test_special_char_pass_neg(mocker):
    ...
    with pytest.raises(RegistrationError) as excinfo:
             employee_serv.add_employee("100001", "ChristopSullivan", "PassWord!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str((excinfo)) == "<ExceptionInfo RegistrationError() tblen=2>"
...
def test_under_pass_neg(mocker):
    ...
    with pytest.raises(RegistrationError) as excinfo:
             employee_serv.add_employee("100001", "ChristopSullivan", "Pas", "Chris", "Sullivan", 0, "email1@revature.net")
    assert str((excinfo)) == "<ExceptionInfo RegistrationError() tblen=2>"
...
def test_name_alpha_neg(mocker):
    ...
    with pytest.raises(RegistrationError) as excinfo:
             employee_serv.add_employee("100001", "ChristopSullivan", "PassWord123!", "Chr1s", "Sullivan", 0, "email1@revature.net")
    assert str((excinfo)) == "<ExceptionInfo RegistrationError() tblen=2>"
...
def test_len_fname_neg(mocker):
    ...
    with pytest.raises(RegistrationError) as excinfo:
             employee_serv.add_employee("100001", "ChristopSullivan", "PassWord123!", "C", "Sullivan", 0, "email1@revature.net")
    assert str((excinfo)) == "<ExceptionInfo RegistrationError() tblen=2>"
...
def test_lname_alpha_neg(mocker):
    ...
    with pytest.raises(RegistrationError) as excinfo:
             employee_serv.add_employee("100001", "ChristopSullivan", "PassWord123!", "Chris", "Su11ivan", 0, "email1@revature.net")
    assert str((excinfo)) == "<ExceptionInfo RegistrationError() tblen=2>"
...
def test_len_lname_neg(mocker):
    ...
    with pytest.raises(RegistrationError) as excinfo:
             employee_serv.add_employee("100001", "ChristopSullivan", "PassWord123!", "Chris", "S", 0, "email1@revature.net")
    assert str((excinfo)) == "<ExceptionInfo RegistrationError() tblen=2>"
...
def test_add_positive(mocker):
    ...
    mocker.patch('backend.dao.employee_dao.EmployeeDao.add_employee', mock_add)
    employee_serv = es.EmployeeService()
    actual = employee_serv.add_employee("100001", "ChristopSullivan", "PassWord123!", "Chris", "Sullivan", 0, "email1@revature.net")
    assert actual == {
        'email_address': 'email1@revature.net',
    'employee_id': '100001',
    'employee_password': 'PassWord123!',
...
def test_add_email_already_in_use_neg(mocker):

    def mock_add(self, employee_id, username, password, fName, lName, type, email):

        if (email == "email1@revature.net"):
            return True
        else:
            return False
